    ...
    let startDayFour = async function () {
        platform.getAllSessions().then((data) => {
            getIndexSessionData(data).then((i) => {
                ...
                else if (updatedDates.fullDate.getDate() == updatedDates.yesterdayPlusOne.getDate() || studySessionData._id == "63c6faf07c10d146b25b6167") { //|| yesterdayPlusOne.getDate() - fullDate.getDate() > 25 ) {)
